...
def drawPressKeyMsg():
    pressKeyFont = pygame.font.SysFont('幼圆', 25)  
    pressKeySurf = pressKeyFont.render('按任意键以继续', True, Black)  
...
def showStartScreen():
    ...
    titleFont = pygame.font.SysFont('幼圆', 100)  
    titleSurf1 = titleFont.render('贪吃蛇', True, White, Red_DARK)  
    degrees1 = 0  
    while True:  
        DISPLAYSURF.fill(BGCOLOR)  
...
def drawScore(score):  
    scoreSurf = BASICFONT.render('Score: %s' % (score), True, DARKGreen)  
